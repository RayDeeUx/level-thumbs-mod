...
class $modify(MyLevelCell, LevelCell) {
    ...
    void loadCustomLevelCell() {
        ...
        if(auto levelListLayer = CCScene::get()->getChildByType<LevelListLayer>(0); levelListLayer->m_levels.size() >= Mod::get()->getSettingValue<int64_t>("level-lists-limit")) return;
